...
STATIC_ROOT = local_settings.PROJECT_ROOT +'static/'
...
WSGI_APPLICATION = 'overtiny.wsgi.application'
...
PASSWORD_HASHERS = (
    'overtiny.hashers.OvertinyPBKDF2PasswordHasher',
